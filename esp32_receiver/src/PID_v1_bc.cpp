...
PID::PID(double* Input, double* Output, double* Setpoint,
        double Kp, double Ki, double Kd, int POn, int ControllerDirection, int YawMode)
{
    myOutput = Output;
    myInput = Input;
    mySetpoint = Setpoint;
...
PID::PID(double* Input, double* Output, double* Setpoint,
    ...
    :PID::PID(Input, Output, Setpoint, Kp, Ki, Kd, P_ON_E, ControllerDirection, YAW_OFF)
{
